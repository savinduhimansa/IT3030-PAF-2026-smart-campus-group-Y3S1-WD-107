          ...
          <nav className="flex-1 p-3 flex flex-col gap-1" id="main-nav">
            {visibleNavItems.map((item) => (
              <NavLink
                ...
                to={item.path}
                className={({ isActive }) =>
                  `flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium cursor-pointer transition-all duration-150 border border-transparent no-underline relative overflow-hidden ${isActive
