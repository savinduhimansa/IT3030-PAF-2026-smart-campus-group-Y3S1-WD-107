                ...
                <div className="flex items-center gap-2">
                    {!isLoggedIn ? (
                        <>
                            ...
                            <Link to="/login" className="ml-2 px-6 py-2.5 rounded-xl text-sm font-bold border border-white/20 hover:border-blue-400 hover:bg-blue-500/10 no-underline" style={{ color: '#ffffff' }}>
                                Login
                            </Link>
                        </>
                    ) : (
