    ...
    <div className="min-h-screen relative overflow-x-hidden light-theme">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Link to="/about" className="px-4 py-2 rounded-xl text-sm font-bold text-[#cbd5e1] hover:text-white transition-all duration-150 no-underline">
            About
          </Link>
          ...
          <Link to="/booking" className="px-4 py-2 rounded-xl text-sm font-bold text-[#cbd5e1] hover:text-white transition-all duration-150 no-underline">
            Booking
          </Link>
